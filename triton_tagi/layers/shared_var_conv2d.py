...
from .conv2d import _triton_col2im, _triton_im2col


class SharedVarConv2D(LearnableLayer):
    """
    ...
    def forward(self, ma: Tensor, Sa: Tensor) -> tuple[Tensor, Tensor]:
        ...
        Sz_flat = Sa_mw2 + Sw_val * (row_ma2 + row_Sa) + Sb_val  # (NL, C_out)
    ...
    def __repr__(self):
        return (
            f"SharedVarConv2D({self.C_in}, {self.C_out}, kernel={self.kH}, "
