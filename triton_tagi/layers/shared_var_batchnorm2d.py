...
from .batchnorm2d import (
    BLOCK,
    _batchnorm_bwd_kernel,
    _batchnorm_fwd_kernel,
    _channel_mean_kernel,
)


class SharedVarBatchNorm2D(LearnableLayer):
    """
    ...
    def num_parameters(self) -> int:
        """Total learnable scalars: gamma/beta means + 2 scalar variances (Sw, Sb)."""
        return self.mw.numel() + self.mb.numel() + 2

    def __repr__(self):
        return (
            f"SharedVarBatchNorm2D(num_features={self.num_features}, "
