"""
CIFAR-10 ResNet-18 with State-Space Momentum
=============================================
Same ResNet-18 architecture as run_resnet18.py, but uses StateSpaceMomentum
as the optimizer instead of standard TAGI updates.

Usage:
    python run_resnet18_momentum.py
    python run_resnet18_momentum.py --sigma-v 0.01
"""
...
# ======================================================================
#  Training loop with StateSpaceMomentum
# ======================================================================
...
def train(opt, net, x_train, y_train_oh, y_train_labels,
          ...
          label_smooth=0.1,
          checkpoint_dir="run_logs_resnet18_momentum/checkpoints",
          start_epoch=1):
...
def main():
    ...
    # ── Monitor ──
    log_dir = "run_logs_resnet18_momentum"
