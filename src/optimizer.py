...
def _adam_tagi_update(m, S, dm, dS, ema_m, ema_v,
                      beta1, beta2, eps, eps_Q,
                      bias_corr1, bias_corr2, cap_factor):
...
class AdamTAGI:
    ...
    def step(self, x_batch, y_batch, sigma_v):
        ...
        for layer in self._learnable_list:
            self._update_param(layer, 'mw', 'Sw', 'delta_mw', 'delta_Sw',
                               cap_factor, bias_corr1, bias_corr2)
    ...
    def _update_param(self, layer, m_attr, S_attr, dm_attr, dS_attr,
        ...
        _adam_tagi_update(
            m, S, dm, dS, ema_m, ema_v,
            self.beta1, self.beta2, self.eps, self.eps_Q,
            bias_corr1, bias_corr2, cap_factor,
        )
    ...
    def __repr__(self):
        ...
        return (f"AdamTAGI(β1={self.beta1}, β2={self.beta2}, "
