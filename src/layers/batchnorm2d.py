...
class BatchNorm2D:
    ...
    def forward(self, mz, Sz):
        ...
        _batchnorm_fwd_kernel[grid](
            ...
            self.mw, self.Sw, self.mb, self.Sb,
            ma, Sa, mhat, Shat,
            N, C, HW,
            self.eps,
            BLOCK=BLOCK,
    ...
    def update(self, cap_factor):
        ...
        """
        update_parameters(self.mw, self.Sw, self.delta_mw, self.delta_Sw,
                          cap_factor)
        update_parameters(self.mb, self.Sb, self.delta_mb, self.delta_Sb,
                          cap_factor)
