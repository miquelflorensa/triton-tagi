...
def train_loop(net, x_train, y_train_oh, x_test, y_test_labels,
               batch_size, sigma_v, n_epochs, label=""):
...
def main():
    ...
    train_loop(net, x_train, y_train_oh, x_test, y_test_labels,
               batch_size, sigma_v, n_epochs, label="forward-scaled")
